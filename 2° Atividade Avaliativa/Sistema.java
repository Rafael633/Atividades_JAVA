public class Sistema {
    public static void main(String[] args) {
        ...
        System.out.println("Receitas da 1°padaria - Padaria das Frituras:");
        for (Receita receita : padariaUm.receitas) {
            System.out.println(receita.nome);
        }
        System.out.println("\n");

        System.out.println("Receitas da 2°padaria - Padaria dos Doces:");
        for (Receita receita : padariaDois.receitas) {
            System.out.println(receita.nome);
        }
        System.out.println("\n");

        System.out.println("Receitas da 3°padaria - Padaria dos Pães:");
